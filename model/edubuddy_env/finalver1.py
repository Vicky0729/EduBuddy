...
먼저원 자에 대해이야기 해볼 까요?원자는모든물질의 기본 단위입니다.원자의구 조는 어떻게생겼 을까요?중앙에핵이있고,그주위를전 자가 돌고있어요.핵은양성자 와중성자로 이루어져있고,전자는그주위를빠르게돌고있습니다.원 자의 크기는매우작아서눈 에보이지않아요.여러분이손 에들고있는 펜이나종이도모두원자로 이루어져있답니다.원자는종류에따라서로다른특성을가지고있 어요.
